...
// MARK: Claims
@objc(Claims)
public class Claims: NSObject {
    /**
     The "iss" (issuer) claim identifies the principal that issued the
     JWT.  The processing of this claim is generally application specific.
     The "iss" value is a case-sensitive.
     */
    @objc public static let iss: String = "iss"
     ...
     */
    @objc public static let sub: String = "sub"
     ...
     */
    @objc public static let aud: String = "aud"
     ...
     */
    @objc public static let exp: String = "exp"
     ...
     */
    @objc public static let nbf: String = "nbf"

    /**
     The "iat" (issued at) claim identifies the time at which the JWT was
     issued.  This claim can be used to determine the age of the JWT.
     */
    @objc public static let iat: String = "iat"
    ...
    /**
     ...
     sensitive
     */
    @objc public static let jti: String = "jti"
